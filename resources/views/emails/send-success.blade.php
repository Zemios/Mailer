...
<body>
    <div class="container">
        <h2>Gracias por contactar con Zemios</h2>

        <div class="content">
          <p>Hola {{ $name }},</p>
      
          <p>Hemos recibido tu mensaje correctamente y queremos agradecerte por tomarte el tiempo en contactarnos.</p>
          ...
          <p>Un saludo,</p>
          <p>El equipo de Zemios</p>
        </div>      

        <!-- Footer igual que el anterior -->
